...
/***/ "./node_modules/raw-loader/index.js!./src/app/components/app-intern/app-intern.component.html":
/*!*******************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/components/app-intern/app-intern.component.html ***!
  \*******************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = "<div class=\"container\">\n\n  <div class=\"row mb-3\" *ngFor=\"let day of days | async | orderBy: 'id' : true\">\n\n    <div class=\"col-12 overflow-hidden d-flex justify-content-between\" (click)=\"show(day)\">\n      <span>{{ day.id }}</span>\n      <span>{{ day.cfhn + day.sfz + day.events + day.visitors + day.makers }}</span>\n    </div>\n\n    <div class=\"col-12 pl-5 overflow-hidden d-flex justify-content-between\" *ngIf=\"visibleDayId == day.id\">\n      <span>CFHN</span><span>{{ day.cfhn }}</span>\n    </div>\n    <div class=\"col-12 pl-5 overflow-hidden d-flex justify-content-between\" *ngIf=\"visibleDayId == day.id\">\n      <span>SFZ</span><span>{{ day.sfz }}</span>\n    </div>\n    <div class=\"col-12 pl-5 overflow-hidden d-flex justify-content-between\" *ngIf=\"visibleDayId == day.id\">\n      <span>Events</span><span>{{ day.events }}</span>\n    </div>\n    <div class=\"col-12 pl-5 overflow-hidden d-flex justify-content-between\" *ngIf=\"visibleDayId == day.id\">\n      <span>Mitarbeitende</span><span>{{ day.employees }}</span>\n    </div>\n    <div class=\"col-12 pl-5 overflow-hidden d-flex justify-content-between\" *ngIf=\"visibleDayId == day.id\">\n      <span>Sonstige</span><span>{{ day.makers }}</span>\n    </div>\n    <div class=\"col-12 pl-5 overflow-hidden d-flex justify-content-between\" *ngIf=\"visibleDayId == day.id\">\n      <span>Durchlauf</span><span>{{ day.visitors }}</span>\n    </div>\n\n  </div>\n</div>\n\n<div class=\"\"></div>"
...
module.exports = "<div class=\"fluid-container position-fixed fixed-bottom bg-dark text-light p-2\">\n    \n    <div class=\"row\">\n        <button type=\"button\" class=\"col btn btn-outline-primary navbar-text\" (click)=\"add('visitors')\"><span style=\"font-size: 50%\">Durchlauf</span></button>\n        <button type=\"button\" class=\"col btn btn-outline-primary navbar-text\" (click)=\"add('sfz')\"><span style=\"font-size: 50%\">SFZ</span></button>\n        <button type=\"button\" class=\"col btn btn-outline-primary navbar-text\" (click)=\"add('events')\"><span style=\"font-size: 50%\">Events</span></button>\n        <button type=\"button\" class=\"col btn btn-outline-primary navbar-text\" (click)=\"add('employees')\"><span style=\"font-size: 50%\">MAs</span></button>\n        \n    </div>\n    <div class=\"row\">\n        <button type=\"button\" class=\"col-6 btn btn-outline-primary navbar-text\" (click)=\"add('cfhn')\"><span>CFHN</span></button>\n        <button type=\"button\" class=\"col-6 btn btn-outline-primary navbar-text\" (click)=\"add('makers')\">Allgemein</button>\n    </div>\n\n    <div class=\"row mt-2\" style=\"font-size: 50%;\">\n        <span *ngIf=\"user\">{{ user.email }}</span>\n    </div>\n\n\n</div>"
...
module.exports = "<div class=\"container\" style=\"height: 100vh;\">\n    <div class=\"row\" style=\"height: 100%;\">\n        <div class=\"col d-flex justify-content-center align-items-center\">\n\n            <div class=\"card\">\n                <div class=\"card-body\">\n                    <h5 class=\"card-title\">LOGIN</h5>\n                    <p class=\"card-text\">\n                        <input type=\"email\" class=\"form-control mb-3\" id=\"inputEmail3\" placeholder=\"Email\" [(ngModel)]=\"user\">\n                        <input type=\"password\" class=\"form-control mb-5\" id=\"inputPassword3\" placeholder=\"Password\" [(ngModel)]=\"password\">\n                    </p>\n                    <a (click)=\"clickLogin()\" class=\"btn btn-primary\">Login</a>\n                </div>\n            </div>\n\n        </div>\n    </div>\n</div>"
...
module.exports = "<nav id=\"nightcamp-navigation\" class=\"position-sticky sticky-top navbar navbar-dark bg-dark\">\n    <a class=\"navbar-brand text-light\" href=\"#\">STAT</a>\n</nav>"
...
/* harmony import */ var _components_log_log_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/log/log.component */ "./src/app/components/log/log.component.ts");
...
/* harmony import */ var _components_app_intern_app_intern_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/app-intern/app-intern.component */ "./src/app/components/app-intern/app-intern.component.ts");
...
const routes = [
    ...
    {
        path: 'app',
        component: _components_app_intern_app_intern_component__WEBPACK_IMPORTED_MODULE_7__["AppInternComponent"],
        canActivate: [_angular_fire_auth_guard__WEBPACK_IMPORTED_MODULE_8__["AngularFireAuthGuard"]],
        children: [
            { path: 'log', redirectTo: '/app/log/' + (new Date()).getFullYear() + '-' + (new Date()).getMonth() + '-' + (new Date()).getDay(), pathMatch: 'full' },
            { path: 'log/:day', component: _components_log_log_component__WEBPACK_IMPORTED_MODULE_5__["LogComponent"] },
...
/* harmony import */ var _components_log_log_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./components/log/log.component */ "./src/app/components/log/log.component.ts");
/* harmony import */ var _components_app_intern_app_intern_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./components/app-intern/app-intern.component */ "./src/app/components/app-intern/app-intern.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_log_log_component__WEBPACK_IMPORTED_MODULE_14__["LogComponent"],
            _components_app_intern_app_intern_component__WEBPACK_IMPORTED_MODULE_15__["AppInternComponent"],
        ...
        imports: [
            ...
            _angular_service_worker__WEBPACK_IMPORTED_MODULE_19__["ServiceWorkerModule"].register('ngsw-worker.js', { enabled: src_environments_environment__WEBPACK_IMPORTED_MODULE_10__["environment"].production })
        ],
        providers: [
...
/***/ "./src/app/components/app-intern/app-intern.component.scss":
/*!*****************************************************************!*\
  !*** ./src/app/components/app-intern/app-intern.component.scss ***!
  \*****************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2NvbXBvbmVudHMvYXBwLWludGVybi9hcHAtaW50ZXJuLmNvbXBvbmVudC5zY3NzIn0= */"

/***/ }),

/***/ "./src/app/components/app-intern/app-intern.component.ts":
/*!***************************************************************!*\
  !*** ./src/app/components/app-intern/app-intern.component.ts ***!
  \***************************************************************/
/*! exports provided: AppInternComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AppInternComponent", function() { return AppInternComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");


let AppInternComponent = class AppInternComponent {
    constructor() { }
    ngOnInit() {
    }
};
AppInternComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-app-intern',
        template: __webpack_require__(/*! raw-loader!./app-intern.component.html */ "./node_modules/raw-loader/index.js!./src/app/components/app-intern/app-intern.component.html"),
        styles: [__webpack_require__(/*! ./app-intern.component.scss */ "./src/app/components/app-intern/app-intern.component.scss")]
    })
], AppInternComponent);
...
let DashboardComponent = class DashboardComponent {
    constructor(db) {
        this.db = db;
        this.visibleDayId = moment__WEBPACK_IMPORTED_MODULE_4__().format(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].dateformat);
        this.dayCollection = db.collection('days');
        this.days = this.db.collection('days').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => actions.map(a => {
...
/* harmony import */ var src_app_models_day__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/models/day */ "./src/app/models/day.ts");
...
let FooterComponent = class FooterComponent {
    constructor(auth, db) {
        ...
        this.db = db;
        this.dayCollection = db.collection('days');
        this.days = this.dayCollection.valueChanges();
        this.todayDoc = db.doc('days/' + moment__WEBPACK_IMPORTED_MODULE_5__().format(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].dateformat));
        this.todayDoc.valueChanges().subscribe(val => {
            if (val) {
                console.log(val);
                this.today = val;
            }
            else {
                let t = new src_app_models_day__WEBPACK_IMPORTED_MODULE_4__["Day"]();
                this.dayCollection.doc(moment__WEBPACK_IMPORTED_MODULE_5__().format(src_environments_environment__WEBPACK_IMPORTED_MODULE_6__["environment"].dateformat)).set(Object.assign({}, t));
            }
        });
    ...
    add(key) {
        this.today[key]++;
        this.todayDoc.update(this.today);
    }
};
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/fire/firestore */ "./node_modules/@angular/fire/firestore/es2015/index.js");
/* harmony import */ var src_app_models_day__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/models/day */ "./src/app/models/day.ts");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! moment */ "./node_modules/moment/moment.js");
/* harmony import */ var moment__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(moment__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var src_environments_environment__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/environments/environment */ "./src/environments/environment.ts");
...
let NavigationComponent = class NavigationComponent {
    constructor(db) {
        ...
        this.dayCollection = db.collection('days');
        this.days = this.dayCollection.valueChanges();
        this.todayDoc = db.doc('days/' + moment__WEBPACK_IMPORTED_MODULE_4__().format(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].dateformat));
        this.todayDoc.valueChanges().subscribe(val => {
            if (val) {
                console.log(val);
                this.today = val;
                ...
                let t = new src_app_models_day__WEBPACK_IMPORTED_MODULE_3__["Day"]();
                this.dayCollection.doc(moment__WEBPACK_IMPORTED_MODULE_4__().format(src_environments_environment__WEBPACK_IMPORTED_MODULE_5__["environment"].dateformat)).set(Object.assign({}, t));
            }
        });
    }
    ngOnInit() {
...
const environment = {
    ...
    firebase: {
        apiKey: "AIzaSyALL98Uo4DBdcN1HffyNaw5ofeYKQx-3Fc",
        authDomain: "stats-mse-hn.firebaseapp.com",
        databaseURL: "https://stats-mse-hn.firebaseio.com",
        projectId: "stats-mse-hn",
        storageBucket: "stats-mse-hn.appspot.com",
        messagingSenderId: "542104544375",
        appId: "1:542104544375:web:aa4132c5822a45c0"
    }
};
/*
...
module.exports = __webpack_require__(/*! C:\Users\jonathan.guenz\code\toolbox\webapp-counter\src\main.ts */"./src/main.ts");
